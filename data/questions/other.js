...
export default [
  {
    ...
    correctAnswers: ['b'],
    explanation: "La marque de brique est positionnée par rapprt à la ligne d'en-but, d'une distance égale à la profondeur de la zone d'en-but, soit 18 mètres.",
    rules: ['2.5.'],
    source: "Martin",
    level: Levels.MIDDLE,
  },
