...
Cependant, si un joueur attrape le disque en courant ou en sautant, le joueur peut faire une passe sans réduire sa vitesse et sans établir de point pivot, à condition qu’il ne change pas de direction ou n'augmente pas sa vitesse jusqu'à ce qu'il lâche le disque et qu’un maximum de deux points de contact avec le sol supplémentaires soient établis après le « catch » et avant qu'il ne lâche le disque.`,
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      '17.2.2. Après une faute de réception acceptée le joueur ayant subi la faute gagne la possession à l’endroit de la transgression même si cet endroit est dans une zone d’en-but, et le jeu reprend par un « check ».',
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      "17.2.1.1. Le contact avec les bras ou les mains d'un adversaire, qui survient après que le disque a été attrapé, ou après que l'adversaire ne peut plus jouer le disque, n'est pas une condition suffisante pour une faute, mais devrait être évité (à l'exclusion du strip et du jeu dangereux)",
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.MIDDLE,
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      "Règle 13.2.1 : Un « turnover » qui transfère la possession du disque d'une équipe à l'autre et arrête le jeu se produit quand il y a une faute offensive acceptée sur une réception",
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.MIDDLE,
  },
  ...
  },
  {
    ...
    correctAnswers: ['a'],
    explanation:
      "Règle 1.10.2 : Les non-joueurs, indépendamment des capitaines, doivent s’abstenir d’intervenir. Cependant les joueurs peuvent prendre l’avis d’autres personnes pour clarifier les règles et aider les joueurs à faire l'appel approprié.",
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.MIDDLE,
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      "Ils doivent faire le check à l'endroit de la faute. Puis l'attaquant doit revenir à la ligne d'entrée de zone pour établir son pied de pivot (17.6)",
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.DIFFICULT,
  },
...
-official annotations 16.6`,
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      "Les non-joueurs sur la sideline peuvent donner leur avis si et seulement s'ils ont été sollicités par une personne impliquée dans l'appel (1.10).",
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.MIDDLE,
  },
  ...
  },
  {
    ...
    correctAnswers: ['a', 'b'],
    explanation:
      'La réponse se trouve dans rules of ultimate, paragraphe 19.1.2 et official annotations, paragraphe 19.1',
    rules: undefined,
    source: 'Monkeys - Pierre Gruau',
    level: Levels.DIFFICULT,
  },
  ...
  },
  {
    category: Categories.TIMEOUT,
    question:
      'Il y a un turnover en dehors du terrain. Je dois attendre d’avoir établi mon pied de pivot pour appeler le temps mort.',
    image: undefined,
    answerChoices: {
      a: 'Vrai',
      b: 'Faux',
