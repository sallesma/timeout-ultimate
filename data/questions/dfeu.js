...
export default [
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Le défenseur peut compter s'il est à moins de 3 mètres du lanceur et ne commet pas d'infraction de marque.",
  ...
  },
  {
    ...
    correctAnswers: ['c'],
    explanation: "C'est bien le « d » de « dix » qui marque la fin du compte. L'appel « Stall out » vient simplement signifier que « dix » a été atteint.",
    rules: ['13.2.', '13.2.2.'],
    source: "DFEU - Pablo",
    level: Levels.EASY,
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Le point est marqué au moment du catch, que l'attaquant en ait conscience ou non. La tentative de passe ratée ensuite n'a donc pas d'importance car le point est déjà marqué (à condition que quelqu'un ait appelé « point » sur le terrain).",
    rules: ['14.4.'],
    source: "DFEU - Pablo",
  ...
  },
  {
    ...
    question: "Un attaquant touche le disque en l'air en essayant de l'attraper, mais ne réussit pas. Le défenseur commet alors une faute sur l'attaquant et l'empêche de faire une deuxième tentative pour attrapper le disque",
    image: undefined,
    answerChoices: {
  ...
  },
  {
    ...
    correctAnswers: ['c'],
    explanation: "C'est un pick. Le défenseur peut aussi prendre 2 secondes avant de l'appeler pour vérifier s'il a un impact sur le jeu ou pas.",
