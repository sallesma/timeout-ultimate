...
Cependant, les annotations (13.11) précisent que les lignes étant très étroites et la conséquence sur le jeu négligeable, il est acceptable de placer son pied de pivot sur la ligne.`,
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation:
      'Mon défenseur récupère le disque. Une faute ayant été appelée, le jeu s’arrête. Sur une faute offensive non contestée, c’est obligatoirement le défenseur qui l’a subie qui récupère le disque (règle 13.5.2)',
    rules: undefined,
    source: 'Disque Tu Sais - Pablo',
    level: Levels.MIDDLE,
  },
