...
//   },
  ...
  },
  {
    ...
    answerChoices: {
      ...
      b: "Le défenseur le plus proche appelle « disc in »",
      c: "Le défenseur le plus proche fait un check au sol",
      d: "L'attaquant le plus proche fait un check au sol",
    },
    correctAnswers: ['b'],
    explanation: "Règle 10.6.2 : Le défenseur le plus proche du disque doit appeler « disc in ». Parfois, les joueurs ont coutume de checker le sol en même temps (pas notifié dans le règlement).",
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  {
...
Cependant, les annotations (13.11) précisent que les lignes étant très étroites et la conséquence sur le jeu négligeable, il est acceptable de placer son pied de pivot sur la ligne.`,
  ...
  },
  {
    ...
    correctAnswers: ['a'],
    explanation: "Le disque est « mort » dès lors qu’il touche l’extérieur de l’aire de jeu ou un attaquant hors-jeu. L’attaquant doit donc établir son pivot dans l’aire de jeu au point le plus proche de l’endroit où le disque est sorti. C'est une violation (« travel »)",
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  {
