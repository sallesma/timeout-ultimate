...
//   },
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Le brick ne fait pas partie des situations requiérant un check. Dès que mon pivot est établi sur le brick, je peux lancer. La règle 7.5.2 le confirme également.",
    rules: ["10.1.","7.5.2."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Je peux faire ma passe, sans check, soit de là où j’ai ramassé le disque soit à l’entrée de ma zone (un pied hors zone). Les annotations (10.1) précisent également ce cas.",
    rules: ["10.1."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
...
Cependant, les annotations (13.11) précisent que les lignes étant très étroites et la conséquence sur le jeu négligeable, il est acceptable de placer son pied de pivot sur la ligne.`,
  ...
  },
  {
    ...
    correctAnswers: ['a'],
    explanation: "L’attaquante doit donc établir son pivot dans l’aire de jeu au point le plus proche de l’endroit où le disque est sorti. C'est une violation (« travel »)",
    rules: ["13.8."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
