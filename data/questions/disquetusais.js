...
`,
  ...
  {
    category: Categories.SPIRIT,
    question: "Je suis sur le terrain, proche de l’action. Bien qu’ayant vu que l’appel de ma coéquipière était faux ou inutile, je ne dois rien dire tant que l’on ne me demande pas ce que j’ai vu.",
    image: undefined,
    answerChoices: {
        a: "Vrai",
        b: "Faux",
...
`,
  ...
  {
    category: Categories.FIELD,
    question: "Une attaquante attrape le disque en l’air. À la réception, ses pieds touchent le sol en même temps avec un pied sur la ligne d’en-but et l’autre dans la zone attaquée.",
    image: undefined,
    answerChoices: {
        a: "Il y a point",
  ...
  {
    category: Categories.FIELD,
    question: "Ma coéquipière a le disque le long de la ligne de touche. Des personnes situées à 2 mètres du terrain l’empêchent de faire une passe.",
    image: undefined,
    answerChoices: {
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "J'ai 20 secondes pour jouer le disque. Ce délais et les cas particuliers sont mentionnées dans l'annexe des règles A5.8.2 (https://rules.wfdf.org/documents/wfdf-rules-of-ultimate-2021-2024-appendix-v2-0/download)",
    rules: undefined,
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
...
//   },
  {
    category: Categories.PULL,
    question: "Sur l’engagement, une attaquante fait volontairement tomber le disque à terre afin de gagner du terrain.",
    image: undefined,
    answerChoices: {
        a: "C'est un turnover",
        b: "Le jeu continue",
    ...
    correctAnswers: ['a'],
    explanation: "Même si les défenseurs s’aperçoivent qu’elle n’avait pas l’intention de l’arrêter, à partir du moment où elle le touche, elle doit l’attraper. Il y a donc un changement de possession (« turnover »).",
    rules: ["7.8."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.EASY,
  },
...
//   },
  {
    category: Categories.COUNT,
    question: "Je suis la défenseuse à la marque. J’en suis à 5 au compte et m’éloigne à plus de 3 mètres de la lanceuse. Que dois-je faire si je reviens à moins de 3 mètres et suis encore à la marque ?",
    image: undefined,
    answerChoices: {
    ...
    correctAnswers: ['a'],
    explanation: "C'est une nouvelle marque, je dois reprendre le compte à 1. Idem si quelqu'un d'autre me remplace à la marque.",
    rules: ['9.4.'],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
...
//   },
  ...
  },
  {
    ...
    correctAnswers: ['c'],
    explanation: "Ils doivent se replacer là où ils étaient au moment où le disque a été lâché ou au moment de l’appel, considérant l’évènement arrivé en premier",
    rules: ["10.2.2.1."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.DIFFICULT,
  },
  {
    ...
    correctAnswers: ['c'],
    explanation: "Ils doivent se replacer là où ils étaient au moment où le disque a été attrapé ou quand le disque à touché le sol",
    rules: ["10.2.2.2."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.DIFFICULT,
  },
...
//   },
  ...
  {
    category: Categories.CHECK,
    question: "Je me place sur le point de brick. Avant de faire ma passe je dois attendre que mon adversaire « check » le disque",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
    ...
    correctAnswers: ['b'],
    explanation: "Le brick ne fait pas partie des situations requiérant un check. Dès que mon pied de pivot est établi sur le brick, je peux lancer. La règle 7.5.2 le confirme également.",
    rules: ["10.1.","7.5.2."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  {
    category: Categories.CHECK,
    question: "Turnover dans ma zone d’en-but. Je ramasse le disque et je sors de ma zone. Je dois checker le disque au sol avant ma passe.",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
    ...
    correctAnswers: ['b'],
    explanation: "Je peux faire ma passe, sans check, soit de là où j’ai ramassé le disque soit à l’entrée de ma zone (pied de pivot hors de la zone). Les annotations (10.1) précisent également ce cas.",
    rules: ["10.1."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Je peux faire ma passe, sans check. Une fois sorti de la zone, je peux faire ma passe sans check. Les annotations (10.1) précisent également ce cas.",
    rules: ["10.1.", "13.10."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  ...
  {
    category: Categories.OUT,
    question: "Une attaquante prend son appel à l’extérieur du terrain, attrape le disque avec les pieds décollés du sol et atterrit dans la zone d’en-but adverse. Le point est-il validé ?",
    image: undefined,
    answerChoices: {
      a: "Oui",
      b: "Non",
  ...
  {
    category: Categories.OUT,
    question: "En effectuant sa passe, le lanceur met un pied en dehors du terrain. Même si la passe est réussie le disque revient au marqueur qui avait appelé « hors-limites ».",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
  ...
  {
    category: Categories.OUT,
    question: "Après avoir attrapé le disque dans le terrain, l'attaquante sort du terrain. L’équipe adverse récupère le disque.",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
    ...
    correctAnswers: ['b'],
    explanation: "Elle garde le disque et établit son pivot dans l’aire de jeu au point le plus proche de l’endroit où elle est sortie",
    rules: ["11.3.2."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.EASY,
  },
...
Cependant, les annotations (13.11) précisent que les lignes étant très étroites et la conséquence sur le jeu négligeable, il est acceptable de placer son pied de pivot sur la ligne.`,
  ...
  {
    category: Categories.OUT,
    question: "Le disque roule en dehors de l’aire de jeu et revient dans le terrain. L’attaquante le joue de là où il s’est arrêté. Que puis-je appeler ?",
    image: undefined,
    answerChoices: {
      a: "Une violation",
      b: "Une infraction",
    ...
    correctAnswers: ['a'],
    explanation: "L’attaquante doit établir son pivot dans l’aire de jeu au point le plus proche de l’endroit où le disque est sorti. C'est une violation (« travel »)",
    rules: ["13.8."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
  ...
  },
  {
    ...
    correctAnswers: ['a'],
    explanation: "Priorité à l’attaquante qui conserve le disque. Sans appel de l’une ou l’autre, il n’y a pas d’arrêt de jeu.",
    rules: ["12.3."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.EASY,
  },
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "« Tous les joueurs doivent essayer d’éviter les contacts. Néanmoins un contact accidentel n’affectant pas le résultat d’une action ou la sécurité des joueurs n'est pas considéré comme une faute ». Il avait donc raison de contester car c’est moi qui n’aurait pas dû appeler la faute.",
    rules: ["12.8."],
    source: "Disque Tu Sais - Pablo",
    level: Levels.DIFFICULT,
  },
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Si le disque touche l’herbe ou une fleur avant d’être catché, il est considéré comme « down ». Il y a donc un changement de possession (« turnover »). Voir dans les règles le lexique et la définition de « sol »",
    rules: undefined,
    source: "Disque Tu Sais - Pablo",
    level: Levels.EASY,
  },
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Mon défenseur récupère le disque. Une faute ayant été appelée, le jeu s’arrête. Sur une faute offensive non contestée, c’est obligatoirement le défenseur qui l’a subie qui récupère le disque (règle 13.5.2)",
    rules: undefined,
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
...
« Si le jeu s'est arrêté pour une discussion sans qu'un « appel » n'ait été fait, l’appel est considéré avoir eu lieu quand la discussion a commencé ».`,
  ...
  {
    category: Categories.FOULS_INFRACTIONS_VIOLATIONS,
    question: "À la fin de son lancer, l’attaquante me met la main au visage. J’appelle  une « faute. » La passe est réussie. Que se passe-t-il ?",
    image: undefined,
    answerChoices: {
...
Une fois la possession établie si l'équipe qui a appelé la faute ou la violation gagne ou maintient la possession après la passe, le jeu continue sans arrêt de jeu. Les joueurs reconnaissant ceci peuvent appeler « play on » pour indiquer que cette règle a été appelée.`,
  ...
  {
    category: Categories.CONTINUATION,
    question: "Je lance le disque et subis à ce moment un contact de ma défenseuse. J’appelle faute. Ma passe est ratée. Que se passe-t-il ?",
    image: undefined,
    answerChoices: {
...
Si le résultat n'était pas un point marqué, les joueurs affectés peuvent réajuster leurs placements désavantageux provoqués par la faute, la violation ou l'appel, et le jeu reprend par un « check ».`,
  ...
  {
    category: Categories.FOULS,
    question: "Je suis défenseuse. J’intercepte le disque et touche juste après une attaquante. Elle appelle « faute ». Je ne conteste pas. Que se passe-t-il ?",
    image: undefined,
    answerChoices: {
...
« Marcher » (« Travel »)`,
  ...
  {
    category: Categories.INFRACTIONS_VIOLATIONS,
    question: "Ma marqueuse commence le compte sans avoir dit « compté » ou « stalling ». Je peux appeler une « faute » ?",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
  ...
  {
    category: Categories.INFRACTIONS_VIOLATIONS,
    question: "Si ma marqueuse ne soustrait pas correctement ou ne recommence pas le compte quand nécessaire, que fais-je ?",
    image: undefined,
    answerChoices: {
...
Le règlement précise « qu’une simple course dans cette zone des 3 mètres n'est pas un « double team ». Ma course pour sortir de cette zone ne peut donc pas être considérée comme une infraction.`,
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Le jeu n’est pas mort. Par conséquent, les autres joueurs peuvent être mobiles. Le lanceur doit établir son pivot au bon endroit avant de pouvoir lancer le disque. Pendant ce temps, je ne compte plus. Un fois placé correctement, je reprends le compte où il en était. Dans cette situation, « compté 5 ».",
...
« S’il se lève il ne s'agit pas d'un « travel », du moment qu'il établit son pivot au même endroit ».`,
  ...
  {
    category: Categories.INFRACTIONS_VIOLATIONS,
    question: "Que se passe-t-il après une infraction de « marcher » contestée si la lanceuse n'a pas lancé le disque ?",
    image: undefined,
    answerChoices: {
      a: "Le jeu est stoppé",
  ...
  {
    category: Categories.INFRACTIONS_VIOLATIONS,
    question: "Je suis en attaque. Je fais un appel et suis gêné dans ma course par une défenseuse. Je peux appeler « une obstruction »(« pick ») ?",
    image: undefined,
    answerChoices: {
      a: "Vrai",
      b: "Faux",
  ...
  {
    category: Categories.INFRACTIONS_VIOLATIONS,
    question: "Le « jeu est mort » suite à l’appel d’une faute. La marqueuse « check » le disque avant que tout le monde se soit replacé correctement. Que puis-je faire ?",
    image: undefined,
    answerChoices: {
      a: "Rien",
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "Si la blessure a été causée par un adversaire, je peux choisir de rester sur le terrain ou d'être remplacé.",
    rules: ['19.1.3.'],
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
...
- si l'appel ou le problème technique ont affecté le jeu, le disque est retourné au lanceur. `,
  ...
  {
    category: Categories.STOPPAGE,
    question: "L’équipe adverse remplace une joueuse blessée. À bout de souffle, je souhaite me faire remplacer à ce moment. Ai-je le droit ?",
    image: undefined,
    answerChoices: {
      a: "Oui",
      b: "Non",
