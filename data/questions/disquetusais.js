...
//   },
  ...
  },
  {
    ...
    correctAnswers: ['b'],
    explanation: "En prenant son appel à l’extérieur du terrain, la joueuse est hors-jeu.",
    rules: undefined,
    source: "Disque Tu Sais - Pablo",
    level: Levels.EASY,
  },
...
Cependant, les annotations (13.11) précisent que les lignes étant très étroites et la conséquence sur le jeu négligeable, il est acceptable de placer son pied de pivot sur la ligne.`,
  ...
  },
  {
    ...
    correctAnswers: ['a'],
    explanation: "Le disque est « mort » dès lors qu’il touche l’extérieur de l’aire de jeu ou un attaquant hors-jeu. L’attaquante doit donc établir son pivot dans l’aire de jeu au point le plus proche de l’endroit où le disque est sorti. C'est une violation (« travel »)",
    rules: undefined,
    source: "Disque Tu Sais - Pablo",
    level: Levels.MIDDLE,
  },
