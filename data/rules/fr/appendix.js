export default {
  ...
  'Appendix A: WFDF Additional Championship Game Rules': {
    'A1. Playing Field': {
      ...
      'A1.7.1.':
        'Anyone who is not registered as a player or a NPTS, shall be deemed a spectatorwith restricted access rights.',
      'A1.8.':
    ...
    'A2. Equipment': {
      ...
      'A2.1.2.': 'The team in possession may choose to substitute a disc during play in the followingsituations:',
      'A2.1.2.1.':
    ...
    'A4. Length of Game': {
      ...
      'A4.2.2.':
        'At time cap the game continues until completion of the current point. If at the completion of the current point neither team has reached fifteen (15) goals, one (1) goal is added to the highest score to determine a time cap target. The game continues until a team wins by reaching the time cap target.',
      ...
      'A4.3.2.1.':
        'After seven (7) minutes the timing for the start of the first point of thehalf begins, as per A5.4.',
      'A4.3.2.2.':
        'If time cap occurs during the seven (7) minutes of half time, then thecurrent point is deemed to already have been completed as per A4.2.2.',
      'A4.4.': 'Half Time Cap:',
      'A4.4.1.':
        'The half time cap occurs after fifty-five (55) minutes of game time, if the half timetarget has not been reached.',
      'A4.4.2.':
      ...
      'A4.6.':
        'The game clock does not stop for time between points, time-outs or half time. However the game clock does stop for:',
    ...
    'A5. Time Limits': {
      ...
      'A5.4.2.': 'Defence',
      'A5.4.2.1.':
        'The defensive team has seventy-five (75) seconds from the start of a point to pull the disc, or fifteen (15) seconds after the offence has legally signalled readiness, whichever is later.',
      'A5.4.2.1.1.':
      ...
      'A5.4.3.1.':
        'In a mixed division, if applicable, the relevant team has fifteen (15) seconds from the start of a point to indicate whether it will play with four (4) female matching players or four (4) male matching players.',
      'A5.4.3.2.':
        'The relevant team must indicate the personnel ratio (“ratio: female matching” or “ratio: male matching”) verbally and by using the appropriate hand signal.',
      'A5.4.3.3.':
        'If the relevant team fails to indicate the personnel ratio in time, the same personnel ratio as the previous point will be used, or, if at the start of a half, a personnel ratio of three (3) female matching players and four (4) male matching players will be used.',
      ...
      'A5.4.4.3.':
        'Seventy-five (75) seconds after the start of the point, or fifteen (15) seconds after the offence has legally signalled readiness, whichever is later (play must start).',
      'A5.4.4.4.':
      ...
      'A5.4.6.3.':
        'The offence must signal readiness within fifteen (15) seconds of the violation call, and the pull must be released within thirty (30) seconds, or fifteen (15) seconds after the offence has legally signalled readiness, whichever is later.',
      ...
      'A5.6.2.1.':
        'If the defence has not checked the disc in, the offence may announce “delay of game” and, if the delay continues, the offence may call a violation. After the violation call the defence must stop moving and remain at that location until the disc is checked in (rule 9.4 can apply).',
      'A5.6.3.': 'The time keeper will signal:',
      ...
      'A5.7.1.':
        'After fifteen (15) seconds, if the issue is not resolved, a captain from each team should try to help resolve the discussion.',
      'A5.7.1.1.':
      ...
      'A5.7.3.':
        'The timekeeper will signal forty-five (45) seconds after play stopped, and will repeat the signal every fifteen (15) seconds if the discussion has not been resolved.',
      'A5.8.': 'After a turnover, and after the pull:',
      'A5.8.1.':
        'In addition to the time limits described in Rule 8.5.1 of the Rules of Ultimate, a twenty (20) second time limit also applies:',
      ...
      'A5.9.':
        'If a technical or injury stoppage is called whilst a time limit is in place, the time limit shall be paused while the issue is addressed or until the injured player is removed from the playing field.',
      'A5.10.':
      ...
      'A5.11.':
        'If a team chooses to assess a time violation, they must call “violation” and should use Hand Signal No.',
    },
    'A6. Mixed Division': {
      'A6.1.':
        'Events must specify which of the following ratio rules will be used to determine if points are played with a personnel ratio of four (4) female matching players and three (3) male matching players, or with a personnel ratio of three (3) female matching players and four (4) male matching players.',
      'A6.1.1.':
      ...
      'A6.2.2.3.':
        'If there is a breach of A6.2.2.1or A6.2.2.2 then this is to be treated as an offside violation by the defence, in accordance with rule 7.5.',
      'A6.3.':
        'Ratio Rule B (“end zone decides” rule):7A6.3.1. At the start of the game, after the first disc flip, an additional disc flip happens with the winner selecting which end zone is “End zone A”, with the other end zone becoming “End zone B”. At the start of each point the Team that is at End zone A must choose the personnel ratio. This process applies for the first half. For the second half, at the start of each point the Team that is at End zone B must choose the personnel ratio.',
      'A6.4.':
        'At the start of the game team captains must discuss the method/s they intend to use to make personnel match-ups easier to identify. The preferred method should include:',
      'A6.4.1.':
        'If the personnel ratio for a point has four (4) female matching players, then all female matching players on offence should stand on the end zone line using the Hand Signal for Personnel Ratio: Female Matching.',
      'A6.4.2.':
        'If the personnel ratio for a point has four (4) male matching players, then all male matching players on offence should stand on the end zone line using the Hand Signal for Personnel Ratio: Male Matching.',
      'A6.4.3.':
        'The relevant Hand Signal should be held for five (5) seconds and should be undertaken no later than directly after signalling readiness for the pull.',
    },
    'A7. Teams': {
      'A7.1.':
        'A team must have one (1) or two (2) designated team captains, and one (1) or two (2) designated spirit captains, per game.',
      'A7.1.1.':
        'A team captain is a team member, who is eligible to participate in the game, and has been designated to represent the team in decision-making on behalf of the team before, during, and after a game.',
      'A7.1.2.':
        'A spirit captain is a team member, who is eligible to participate in the game, and has been designated to address, discuss, and resolve spirit issues at any point throughout the competition with opponents, teammates, coaches, and game or event officials.',
      'A7.2.':
      ...
      'A7.3.':
        'A team must have seven (7) players available for every point. A team in the mixed division must have four (4) female matching players and four (4) male matching players available for every point.',
      'A7.3.1.':
      ...
      'A7.4.':
        'If a point has commenced and a team does not have exactly seven (7) people playing thepoint, or does not have the correct personnel ratio, then the opposition may call a violation and stop play, or the infringing team may use a time-out to address the issue (as per Rule 20.4).',
      'A7.4.1.':
      ...
      'A7.4.2.':
        'The opposition must choose either to restart play in accordance with a time-out being called (as per Rule 20.3), or to restart the point.',
      'A7.4.3.':
    ...
    'A8. Language': {
      ...
      'A8.1.1.':
        'Players who have significant difficulty communicating verbally must ensure captains discuss appropriate alternatives prior to the start of the game.',
    },
    'A9. Competitive Play': {
      'A9.1.':
    ...
    'A12. Foul and Violation Calls': {
      'A12.1.':
        'A game that involves a significant number of calls, especially when these remain disputed, should be brought to the attention of the Tournament Technical Director or the Tournament Rules Group (TRG) by a captain or game official as soon as possible.',
      'A12.1.1.':
        'If the TRG are made aware of concerns regarding a team’s or an individual’s conduct, a member of the TRG may discuss these issues with the team or individual during the event.',
      ...
      'A12.2.5.':
        'Contacting a member of the TRG to request that a WFDF Official or TRG member attend the remainder of the game.',
    },
    'A13. Spirit Stoppage': {
      'A13.1.':
        'If a team’s captain, spirit captain, a designated WFDF Official, or TRG member, believes that either or both teams are failing to follow (or are at risk of failing to follow) the Spirit of the Game (SOTG), they may call a “Spirit Stoppage”. This can only be called:',
      ...
      'A13.3.':
        'Separately from the spirit circle, the opposing team captains and spirit captains must discuss all current issues with adherence to SOTG, determine actions to rectify those issues, and then convey the agreement to the spirit circle.',
  ...
  'Appendix B: WFDF Additional Championship Event Rules': {
    'B1. Rosters': {
      ...
      'B1.1.3.':
        'A team in the mixed division must also have a minimum of seven (7) female matching players and seven (7) male matching players on its roster.',
      'B1.1.4.':
    ...
    'B2. Divisions': {
      ...
      'B2.1.22.': 'Under-14 Mixed (U14X)11B2.1.23. Under-14 Open (U14O)',
    ...
    'B4. Inclement Weather Rules': {
      ...
      'B4.2.1.4.':
        'If lightning monitoring technology is present at the venue then B4.2.1.3 does not apply and WFDF Officials may act based on the advice of the venue officials.',
      'B4.2.1.5.':
      ...
      'B4.2.3.1.':
        'Players must only return to the playing field once thirty (30) minutes has elapsed since lightning or thunder was last observed, unless lightning monitoring technology is being used, and after official notice from WFDF Officials that return to the field is permitted.',
      'B4.3.': 'Hot weather',
      'B4.3.1.':
      ...
      'B4.4.': 'Air Quality',
      'B4.4.1.':
        'During each days play WFDF Officials will monitor the Air Quality Health Index (AQHI) for the tournament location using local resources.',
      'B4.4.2.': 'If the AQHI is 3 or below, activity will continue as normal.',
      'B4.4.3.': 'If the AQHI is 4-6',
      'B4.4.3.1.':
        'There will be the addition of one official stoppage per half. For a game to 15, the first stoppage occurs when a team reaches 4. The second stoppage occurs when a team reaches 12 or at Time cap. These numbers should be prorated for games played to a different point total.',
      'B4.4.3.2.': 'For each official stoppage, the time prior to the pull is extended by 3 minutes.',
      'B4.4.4.': 'If the AQHI is 7+',
      'B4.4.4.1.':
        'All games are to be suspended until such time as AQHI falls below 7. Players and tournament staff should be told to shelter indoors where possible.',
    },
    'B5. Suspended or Cancelled Play': {
      ...
      'B5.4.1.2.':
        'For a suspension of play where clause B5.4.1.1 does not apply, and one team has scored more breaks than their opponent, then the team who has scored more breaks than their opponent is declared the winner.',
      'B5.4.1.2.1.': 'A break is scored if the team that starts a point on defense scores that point.',
      'B5.4.1.3.':
        'For initial pool play, if clause B5.4.1.1 or B5.4.1.2 do not apply, then the winner of the game will be the higher-seeded team as determined prior to the tournament.',
      'B5.4.1.4.':
        'For subsequent pool play and finals, if clause B5.4.1.1 or B5.4.1.2 do not apply, then the Tournament Rules Group will determine if the game will be considered a draw, or if the winner of the game will be the higher- ranked team at that point (taking into account the results from initial pool play and the WFDF tiebreakers where applicable).',
    ...
    'B6. Tasks of Game Officials': {
      ...
      'B6.3.2.3.':
        'Closely monitor the restraining lines, and encourage teams to comply with the rules concerning those lines.',
      'B6.3.2.4.':
      ...
      'B6.3.2.13.':
        'The TRG may designate specific Game Advisors as Acting Disciplinary Authorities for the Event and such Game Advisors can enforce sanctions during a game as prescribed by the WFDF Conduct Policy.',
      'B6.3.3.':
        'Game Advisors must only provide their non-binding perspective on a play when it isclear and obvious to them what occurred.',
      'B6.3.3.1.':
  ...
  'Appendix C: Uniform Requirements': {
    'C1. Purpose': {
      ...
      'C1.6.':
        'WFDF reserves the right to require a team or player to alter or replace text or graphics on a uniform item or to replace or remove a uniform item.',
    },
    'C2. General': {
      'C2.1.':
    ...
    'C4. Shirts': {
      ...
      'C4.4.2.':
        'Numbers should be a solid colour which has a contrast ratio of at least 6:1 from the primary shirt colour.',
      'C4.5.':
    ...
    'C11. Shoes': {
      'C11.1.': 'Players must wear either shoes or boots. Footwear does not need to be matching in anyway.',
      'C11.2.':
        'Any studs or ridges on the sole of the footwear must not protrude more than 20 millimetres from the sole nor have any sharp edges.',
    },
    'C12. Additional Uniform Requirements for Players': {
      ...
      'C12.4.':
        'Uniform items must not display non-related commercial logos or other non-related symbolism (unless it is in accordance with the WFDF Social Expression Policy).',
  ...
  'Appendix D: WFDF Eligibility and Roster Guidelines': {
    'D1.Team Eligibility - General': {
      ...
      'D1.2.':
        'All players on a Roster must be members of the National Federation in good standing, and must meet whatever other requirements are placed on them by the National Federation.',
      'D1.3.':
      ...
      'D1.5.':
        'The team roster must be inspected by an official of the National Federation who represents the team before being submitted. This official must countersign the roster to indicate they have inspected it and found it to be in accordance with player eligibility.',
      'D1.6.':
    ...
    'D2. Team Eligibility - National Team Rosters': {
      ...
      'D2.1.1.': 'WFDF World Ultimate Championships (WUC)',
      ...
      'D2.3.2.':
        'WFDF Citizen - Players are also deemed to be "WFDF citizens" if they have moved to the country at least forty (40) months prior to January 1st of the year of the event and spent more than 75% of those forty (40) months in the country.',
      'D2.3.3.':
      ...
      'D2.3.4.':
        'For 2026 WFDF plans to remove the rule regarding Players being deemed to be "Resident non-citizens" if they own a legal certificate of permanent residency issued by the country\'s government.',
      ...
      'D2.5.2.':
        'For Teams from small Ultimate communities, the length of time for Resident Non-Citizens referenced in section D2.3.3 will be reduced to six (6) months.',
    },
    ...
    'D4. Player Eligibility - Gender': {
      ...
      'D4.3.':
        'Mixed Divisions – Any player eligible for the Open Division can play as a male matching player. Any player eligible for the Women’s Division can play as a female matching player.',
      'D4.4.': 'Open Divisions – All players are eligible to participate in the Open Divisions of all competitions.',
      'D4.5.':
        'Women’s Divisions – All female matching players are eligible to participate in the Women’s Divisions of all competitions.',
    },
    'D5. Player Eligibility - Age': {
      'D5.1.':
        'In order to be eligible to play in the following WFDF playing divisions, players must meet the specified criteria.',
      'D5.2.':
        'Mixed, Open and Women’s Divisions – A player participating in these divisions must be sixteen (16) years old or older during the calendar year in which the tournament concludes.',
      'D5.3.': 'Master Divisions',
      'D5.3.1.':
        'A player participating in a Master division as a female matching player must be thirty (30) years old or older during the calendar year in which the tournament concludes.',
      'D5.3.2.':
        'A player participating in a Master division as a male matching player must be thirty-three (33) years old or older during the calendar year in which the tournament concludes.',
      'D5.4.': 'Grand Master Divisions',
      'D5.4.1.':
        'A player participating in a Grand Master division as a female matching player must be thirty-seven (37) years old or older during the calendar year in which the tournament concludes.',
      'D5.4.2.':
        'A player participating in a Grand Master division as a male matching player must be forty (40) years old or older during the calendar year in which the tournament concludes.',
      'D5.5.': 'Great Grand Master Divisions',
      'D5.5.1.':
        'A player participating in a Great Grand Master division as a female matching player must be forty-five (45) years old or older during the calendar year in which the tournament concludes.',
      'D5.5.2.':
        'A player participating in a Great Grand Master division as a male matching player must be forty-eight (48) years old or older during the calendar year in which the tournament concludes.',
      'D5.6.':
      ...
      'D5.7.2.':
        'twelve (12) years old or older with the approval of all of those players Parents or Guardians, Head Coach and National Federation, and',
      ...
      'D5.9.':
        'Under-14 (U14) Divisions – A player participating in these divisions must be ten (10) year sold or older and must not be fourteen (14) years old or older during the calendar year in which the tournament concludes.',
      'D5.10.':
    ...
    'D7. Roster Eligibility - Continental Championships (AAUC, AOUC, PAUC)': {
      ...
      'D7.2.':
        'WFDF allows either “National” or “Club” teams to attend Continental Championships to encourage participation. Teams must be designated as either “National” or “Club” teams and National Federations must use the appropriate eligibility criteria when approving rosters.',
      'D7.3.':
        'For countries sending more than one (1) team in a division to an event, a maximum of one(1) team may use the “National Team” eligibility rules, and all of the other teams in the division must use the “Club Team” eligibility rules.',
    },
    'D8. Exemptions': {
      'D8.1.':
  ...
  'Appendix E: Seeding, Schedule and Event Bids': {
    'E1. Seeding for National Team Events (per division)': {
      ...
      'E1.2.2.':
        'where a country did not attend the previous instance of the event being ranked, the World Ultimate Ranking.',
      'E1.3.':
      ...
      'E1.4.1.':
        'WUC: Reorder European Teams, keeping relative position to non-European Teams, based on the most recent European Ultimate Championships.',
      'E1.4.2.':
    ...
    'E3. Seeding Pools (Semi-Random Seeding)': {
      'E3.1.': 'Pools will be seeded using a traditional “snake” numbering system.',
      'E3.2.':
      ...
      'E3.6.':
        'If the placement of a set of teams results in a country having more than two (2) teams for a World event, or more than one (1) team for a Continental event, in a single pool WFDF may adjust the random draw of that set of teams to avoid this situation. Teams may only be moved within their random draw pot of “n” teams (see E3.4) to achieve this goal.',
      'E3.7.':
    ...
    'E5. Bids to Club Team Event (WUCC)': {
      ...
      'E5.1.':
        'National Federations receive one (1) bid in each playing division in which the National Federation participated in the previous WUC event.',
      'E5.2.':
    ...
    'E7. Scheduling Rules': {
      ...
      'E7.1.1.':
        'An exception can be made if an event has an uneven number of teams in the initial pools. In this case teams in pools with more teams may need to play an 24 additional game in round robin play, and an additional team from a larger pool may be eliminated from the next round over a pool with fewer teams.',
      'E7.2.':
    ...
    'E9. Adjustments to seeding and bids.': {
      ...
      'E9.2.':
        'If adjustments are made by the Ultimate Committee, the reasons for these adjustment smust be published by WFDF.',
    },
  },
  'Appendix F: Hand Signals': {
    ...
    'F2. Use of Signals:': {
      ...
      'F2.3.':
        'Non-players should also use signal 22 to indicate which team made the call, after the following calls: Foul, Violation, Retracted, Time-out, Spirit Stoppage and Stoppage.',
    },
  },
};
