// https://www.vertopal.com <- convert pdf to json and then pasted and began manual formatting replaced new lines with ',\n' then can paste ': ' at end of numbers, delete page numbers and make multiline one liners
export default {
  'A1.': 'Playing Field',
  ...
  'C5.': 'Pants ',
  'C5.1.':
    'Pants are deemed to be any clothing that covers at least the lower torso and upper legs C5.2.All players on a team must wear pants that match in colour and pattern. ',
  ...
  'Appendix D:': '  WFDF Eligibility and Roster Guidelines D1.Team Eligibility \u2013 National Team Rosters ',
  'D1.1.':
  ...
  'D1.5.3.': `Resident Non-Citizen - Players are deemed to be \"Resident non-citizens\" if they own a legal certificate of permanent residency issued by the country's government": null, " or if they have moved to the country at least twenty(20) months prior to the start date of the event and spent more than 75% of those twenty (20) months in the country.`,
  ...
  'D6.':
    'Roster Eligibility \u2013 Continental Championships (AAUC, AOUC, PAUC) D6.1.Teams playing at All African Ultimate Championships (AAUC), Asian Oceanic Ultimate Championships (AOUC), or Pan American Ultimate Championships (PAUC) may submit any roster that has been approved by the National Federation of the country they are representing. ',
  'D6.2.':
  ...
  'Appendix E:': 'Seeding, Schedule and Event Bids E1.Seeding for National Team Events (per division) ',
  'E1.1.':
