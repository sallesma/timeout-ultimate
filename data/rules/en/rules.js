export default {
  '1.Spirit of the Game': {
    ...
    '1.2.':
      'It is trusted that no player will intentionally break the rules; thus there are no harsh penalties for inadvertent breaches, but rather a method for resuming play in a manner which simulates what would most likely have occurred had there been n breach.',
    '1.2.1.':
    ...
    '1.3.6.': 'listen to and consider their opponent’s viewpoint;',
    ...
    '1.5.': 'The following actions are some examples of goodSpirit:',
    ...
    '1.5.3.': 'complimenting an opponent for good play orSpirit;',
    '1.5.4.': 'introducing yourself to your opponent;and',
    '1.5.5.': 'reacting calmly towards disagreement or provocation.',
    '1.6.': 'The following actions are clear violations of theSpirit of theGame and must be avoided:',
    ...
    '1.7.1.': 'take responsibility for teaching their team the rules and goodSpirit;',
  ...
  '2.Playing Field': {
    '2.1.':
      'The playing field is a rectangular area with dimensions and zones as shown on Figure 1and should be essentially flat, free of obstructions and afford reasonable player safety.',
    '2.2.':
      'The perimeter lines surround the playing field and consist of two (2) sidelines along the length and two(2) end lines along the width.',
    ...
    '2.7.':
      'The immediate surroundings of the playing field shall be kept clear of movable objects.If play is obstructed by non-players or objects with in three (3) metres of the perimeter line, any obstructed player or thrower in possession may call “Violation”.Figure 1',
  },
  '3.Equipment': {
  ...
  '7. The Pull': {
    ...
    '7.11.':
      'If the disc initially contacts th playing field and then becomes out-of-bounds without contacting an offensive player, the thrower must establish a pivot point where the disc first crossed the perimeter line, or the nearest location in the central zone if that pivot point would be in their defending end zone.',
    '7.11.1.':
  ...
  '8. State of Play': {
    ...
    '8.5.1.':
      'In addition to 8.5, after a turnover the thrower must establish a pivot point within the following time limits, if the disc did not become out-of-bounds, and the disc’s location is:',
  ...
  '9.Stall Count': {
    ...
    '9.3.2.':
      'They are within three (3) metres of the thrower’s pivot point, or the pivot location if the thrower is not at that location; and',
  ...
  '11.Out-of-Bounds': {
    ...
    '11.3.2.1.':
      'If they leave the playing field, they must establish a pivot point at the location on the playing field where they crossed the perimeter line (unless14.3is in effect).',
  ...
  '12.Receivers and Positioning': {
    '12.1.':
      'A“catch”occurs when a player hasa non-spinning disc trapped between at least two body parts. A catch can enable a player to establish possession of the disc.',
    '12.1.1.':
  ...
  '13.Turnovers': {
    ...
    '13.2.2.':
      'the thrower has not released the pass before the marker first starts to say the word “ten” in the stall count (a “stall-out”);',
    '13.2.3.':
    ...
    '13.7.3.': 'the thrower was located at the time of the call, in the case of13.2.2,13.2.3,13.2.4,13.2.5; or',
    ...
    '13.8.':
      'If the turnover location is out-of-bounds, or the disc touched an out-of-bounds area after the turnover occurred, the thrower must establish a pivot point at the location on the central zone nearest to where the disc went out-of-bounds (Section 11.8). 13.8.1. If 13.8 does not apply, a pivot point must be established according to 13.9, 13.10, or 13.11.',
    '13.9.':
  ...
  '14.Scoring': {
    ...
    '14.3.':
      'If a player in possession of the disc ends up in the end zone they are attacking without scoring a goal according to14.1, the player must establish a pivot point at the nearest location on the goal line.',
  ...
  '16.Continuation after aCall': {
    '16.1.':
      'Whenever a foul or violation call is made, or a player attempts to stop play in anyway,play stops immediately and no turnover is possible(unless in situations specified in 15.9, 16.2, and 16.3).',
    '16.2.': 'Ifa foul or violation:',
  ...
  '18.Infractions and Violations': {
    ...
    '18.1.1.5.':
      '"Double Team" – a defensive player other than the marker is within three (3) metres of the thrower\'s pivot point without also guarding another offensive player.',
    '18.1.1.5.1.':
      'The defender guarding another offensive player can attempt to prevent a pass from the thrower, as long as they continue to guard another offensive player.',
    ...
    '18.1.3.':
      'After all marking infractions listed in 18.1.1 and where play has not stopped, the marker must resume the stall count with the number last fully uttered before the call, minus one (1).',
    '18.1.3.1.':
      'The marker must not resume counting until any illegal positioning has been corrected. To do otherwise is a subsequent marking infraction.',
    '18.1.4.':
