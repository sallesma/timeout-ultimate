export default {
  "Aire de Jeu": "La zone incluant la zone centrale et les zones d’en-but mais excluant les lignes de périmètre. Une infraction affecte le jeu s'il est raisonnable de penser que le résultat de l'action aurait été significativement différent sans cette infraction. Un joueur dont l’équipe est en possession du disque.",
  "Affecter le Jeu": "La zone incluant la zone centrale et les zones d’en-but mais excluant les lignes de périmètre. Une infraction affecte le jeu s'il est raisonnable de penser que le résultat de l'action aurait été significativement différent sans cette infraction. Un joueur dont l’équipe est en possession du disque.",
  "Attaquant": "La zone incluant la zone centrale et les zones d’en-but mais excluant les lignes de périmètre. Une infraction affecte le jeu s'il est raisonnable de penser que le résultat de l'action aurait été significativement différent sans cette infraction. Un joueur dont l’équipe est en possession du disque.",
  ...
  "Catch": "Un disque sans rotation coincé entre au moins deux parties du corps. Si un joueur attrape initialement une passe puis, avant d'établir la possession, il ne maintient pas la prise (« maintenir la prise » signifie continuer à avoir un disque qui ne tourne pas coincé entre au moins deux parties du corps), ce « catch » initial est considéré comme terminé.",
  "Contact avec le Sol": "Réfère à tout joueur touchant le sol suite à un événement ou une action incluant l’atterrissage ou la reprise d’appui après une perte d’équilibre (i.e. sauter, plonger, se pencher ou tomber).",
  "Contact mineur": "Un contact qui implique une force physique minimale et ne modifie pas les mouvements ou la position d'un autre joueur. Le contact avec les bras tendus ou les mains d'un adversaire qui sont sur le point ou qui sont déjà en contact avec le disque, ou en contact avec la main du lanceur pendant le mouvement de lancer, n'est pas considéré comme un contact mineur.",
  ...
  "En-but Défendu": "Zone d’en-but dans laquelle l’équipe concernée est en train d’essayer d’empêcher les adversaires de marquer.",
  "Endroit du Pivot": "Le point de l’aire de jeu où le lanceur doit établir un point pivot après un « turnover », après le « pull », après un temps-mort, après être sorti de la zone centrale ou là où le point pivot a déjà été établi.",
  "Faire action sur le disque": "Quand le disque est en l'air et qu'un joueur tente de rentrer en contact avec le disque de quelque manière que ce soit, pour l'attraper ou le bloquer. Ceci inclut la course vers le lieu où il pense entrer en contact avec le disque.",
  "Garder": "Un défenseur garde un attaquant quand il se situe à moins de trois mètres de celui-ci et réagit en fonction de cet attaquant.",
  "Hors-limites": "Tout ce qui ne fait pas partie de l’aire de jeu, incluant les lignes de périmètre.",
  "Interception": "Quand un joueur de l’équipe défensive établit la possession d’un lancer d’un joueur de l’équipe attaquante.",
  "Interruption de jeu": "Tout arrêt de jeu dû à une faute, violation, discussion, appel contesté, blessure ou temps-mort qui nécessite un « check » pour relancer le jeu.",
  ...
  "Ligne": "Une limite définissant les aires de jeu. Sur un terrain sans tracé, les limites sont définies par des lignes imaginaires entre les marqueurs ayant la largeur des dits marqueurs. Les segments de ligne ne sont pas étendus au-delà des marqueurs.",
  "Ligne de But": "La ligne séparant la zone centrale de chaque zone d’en-but. Elle ne fait pas partie de l’en-but.",
  "Lignes de Périmètre": "Lignes séparant la zone centrale ou l’en-but de la zone hors-limites. Elles ne font pas partie de l’aire de jeu.",
  ...
  "Où le disque s’arrête": "Réfère à l’endroit où un joueur établit possession, le disque s’arrête naturellement ou le disque est empêché de rouler ou glisser.",
...
Un joueur établit un point pivot en plaçant, ou en gardant, une partie particulière de son corps en un point spécifique, qu'il a l'intention d'utiliser comme point pivot. Si un lanceur a plusieurs options pour un point pivot, le point pivot n'est pas déterminé tant qu'il n'a pas pivoté .`,
  "Position Légitime": "La position stationnaire ou en mouvement établie par un joueur qui n’est en infraction avec aucune règle.",
...
L’équipe dont le joueur est en possession ou dont les joueurs peuvent ramasser le disque est considérée en possession.`,
  "Pré-compte (Pre-stall)": "Un avertissement concernant les délais pour reprendre le jeu, émis en donnant des avertissements à vingt (20), dix (10) et cinq (5) secondes (selon le cas).",
  ...
  "Turnover": "Tout événement qui produit un changement de l’équipe en possession. Un « turnover » n'est pas considéré comme une violation.",
